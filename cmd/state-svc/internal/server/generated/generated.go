...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "AvailableUpdate.available":
		if e.complexity.AvailableUpdate.Available == nil {
			break
		}

		return e.complexity.AvailableUpdate.Available(childComplexity), true
...
func (ec *executionContext) _AvailableUpdate_available(ctx context.Context, field graphql.CollectedField, obj *graph.AvailableUpdate) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _AvailableUpdate(ctx context.Context, sel ast.SelectionSet, obj *graph.AvailableUpdate) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "available":
			out.Values[i] = ec._AvailableUpdate_available(ctx, field, obj)
