...
/*GetTiersForbidden handles this case with default header values.
...
/*GetTiersNotFound handles this case with default header values.
...
/*GetTiersInternalServerError handles this case with default header values.
