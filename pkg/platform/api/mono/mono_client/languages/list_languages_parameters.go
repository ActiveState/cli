...
func (o *ListLanguagesParams) WithTimeout(timeout time.Duration) *ListLanguagesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list languages params
func (o *ListLanguagesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list languages params
func (o *ListLanguagesParams) WithContext(ctx context.Context) *ListLanguagesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list languages params
func (o *ListLanguagesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list languages params
func (o *ListLanguagesParams) WithHTTPClient(client *http.Client) *ListLanguagesParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the list languages params
func (o *ListLanguagesParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WriteToRequest writes these params to a swagger request
func (o *ListLanguagesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
