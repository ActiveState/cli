...
type V1GpuArchitectureCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1GpuArchitectureCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1GpuArchitectureCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
