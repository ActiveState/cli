...
// V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0 Ingredient Version Core
//
// The fields of an ingredient version that can be updated
// swagger:model v1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0
type V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0 struct {
...
// Validate validates this v1 solution recipe recipe resolved ingredients items ingredient version all of2 all of0
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) validateCopyrightText(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) validateDocumentationURI(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) validateLicenseExpression(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) validateReleaseTimestamp(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) validateSourceURI(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0) UnmarshalBinary(b []byte) error {
	var res V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf0
