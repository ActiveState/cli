...
func (m *OperatingSystemVersionAllOf0) validateLinks(formats strfmt.Registry) error {
...
func (m *OperatingSystemVersionAllOf0) validateOperatingSystemVersionID(formats strfmt.Registry) error {
...
func (m *OperatingSystemVersionAllOf0) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OperatingSystemVersionAllOf0) UnmarshalBinary(b []byte) error {
	var res OperatingSystemVersionAllOf0
