...
// V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems Requirement Sub Schema
//
// An order requirement is a single package name and version specifier requested in an order.
// swagger:model v1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems
type V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems struct {
	...
	// Min Items: 1
	VersionRequirements []*V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItemsVersionRequirementsItems `json:"version_requirements"`
}

// Validate validates this v1 solution recipe recipe resolved ingredients items resolved requirements items
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) validateIngredientVersionID(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) validateRevision(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) validateVersionRequirements(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems) UnmarshalBinary(b []byte) error {
	var res V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems
