...
// V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1
type V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1 struct {
...
// Validate validates this v1 gpu architecture all of1 all of1 provided features items all of1
func (m *V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1) UnmarshalBinary(b []byte) error {
	var res V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItemsAllOf1
