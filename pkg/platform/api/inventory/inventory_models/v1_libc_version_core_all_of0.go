...
// V1LibcVersionCoreAllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1LibcVersionCoreAllOf0
type V1LibcVersionCoreAllOf0 struct {
...
// Validate validates this v1 libc version core all of0
func (m *V1LibcVersionCoreAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1LibcVersionCoreAllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1LibcVersionCoreAllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1LibcVersionCoreAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1LibcVersionCoreAllOf0) UnmarshalBinary(b []byte) error {
	var res V1LibcVersionCoreAllOf0
