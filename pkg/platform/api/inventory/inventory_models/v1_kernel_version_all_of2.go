...
// V1KernelVersionAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1KernelVersionAllOf2
type V1KernelVersionAllOf2 struct {
...
// Validate validates this v1 kernel version all of2
func (m *V1KernelVersionAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1KernelVersionAllOf2) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionAllOf2
