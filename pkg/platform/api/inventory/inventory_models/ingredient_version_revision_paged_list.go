...
func (m *IngredientVersionRevisionPagedList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIngredientVersionRevisions(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *IngredientVersionRevisionPagedList) contextValidateIngredientVersionRevisions(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.IngredientVersionRevisions); i++ {

		if m.IngredientVersionRevisions[i] != nil {
			if err := m.IngredientVersionRevisions[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("ingredient_version_revisions" + "." + strconv.Itoa(i))
				}
				return err
...
func (m *IngredientVersionRevisionPagedList) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IngredientVersionRevisionPagedList) contextValidatePaging(ctx context.Context, formats strfmt.Registry) error {
