...
type V1OperatingSystemVersionCore struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1OperatingSystemVersionCoreProvidedFeaturesItems0 `json:"provided_features"`
}
...
func (m *V1OperatingSystemVersionCore) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCore) validateVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCore) validateProvidedFeatures(formats strfmt.Registry) error {
...
// V1OperatingSystemVersionCoreProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1OperatingSystemVersionCoreProvidedFeaturesItems0
type V1OperatingSystemVersionCoreProvidedFeaturesItems0 struct {
...
// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1OperatingSystemVersionCoreProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)
...
// Validate validates this v1 operating system version core provided features items0
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1OperatingSystemVersionCoreProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersionCoreProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
