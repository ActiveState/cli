...
// V1IngredientVersionRevisionCreateAllOf1AllOf0 v1 ingredient version revision create all of1 all of0
// swagger:model v1IngredientVersionRevisionCreateAllOf1AllOf0
type V1IngredientVersionRevisionCreateAllOf1AllOf0 struct {
	...
	// dependency sets
	DependencySets []*V1IngredientVersionRevisionCreateAllOf1AllOf0DependencySetsItems `json:"dependency_sets"`

	// ingredient options
	IngredientOptions []*V1IngredientVersionRevisionCreateAllOf1AllOf0IngredientOptionsItems `json:"ingredient_options"`
...
// Validate validates this v1 ingredient version revision create all of1 all of0
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) validateDependencySets(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) validateIngredientOptions(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) validateLicenseManifestURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) validatePlatformSourceURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionRevisionCreateAllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionRevisionCreateAllOf1AllOf0
