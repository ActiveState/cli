...
type V1GpuArchitectureAllOf1AllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1GpuArchitectureAllOf1AllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1GpuArchitectureAllOf1AllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
