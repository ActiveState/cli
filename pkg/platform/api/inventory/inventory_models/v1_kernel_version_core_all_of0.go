...
// V1KernelVersionCoreAllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1KernelVersionCoreAllOf0
type V1KernelVersionCoreAllOf0 struct {
...
// Validate validates this v1 kernel version core all of0
func (m *V1KernelVersionCoreAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionCoreAllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreAllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1KernelVersionCoreAllOf0) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionCoreAllOf0
