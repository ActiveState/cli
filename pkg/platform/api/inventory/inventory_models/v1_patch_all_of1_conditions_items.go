...
// V1PatchAllOf1ConditionsItems Condition Sub Schema
//
...
// swagger:model v1PatchAllOf1ConditionsItems
type V1PatchAllOf1ConditionsItems struct {
	...
	// Required: true
	// Min Length: 1
	Requirements []*V1PatchAllOf1ConditionsItemsRequirementsItems `json:"requirements"`
}

// Validate validates this v1 patch all of1 conditions items
func (m *V1PatchAllOf1ConditionsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1PatchAllOf1ConditionsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1PatchAllOf1ConditionsItems) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1PatchAllOf1ConditionsItems) validateRequirements(formats strfmt.Registry) error {
...
func (m *V1PatchAllOf1ConditionsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1PatchAllOf1ConditionsItems) UnmarshalBinary(b []byte) error {
	var res V1PatchAllOf1ConditionsItems
