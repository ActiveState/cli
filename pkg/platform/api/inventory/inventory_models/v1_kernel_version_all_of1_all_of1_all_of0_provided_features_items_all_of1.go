...
// V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1
type V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1 struct {
...
// Validate validates this v1 kernel version all of1 all of1 all of0 provided features items all of1
func (m *V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1
