...
// V1SolutionRecipeRecipeResolvedIngredientsItems Resolved Ingredient
//
// An ingredient that is part of a recipe's resolved requirements
// swagger:model v1SolutionRecipeRecipeResolvedIngredientsItems
type V1SolutionRecipeRecipeResolvedIngredientsItems struct {
	...
	BuildScripts []*V1SolutionRecipeRecipeResolvedIngredientsItemsBuildScriptsItems `json:"build_scripts"`
	...
	Dependencies []*V1SolutionRecipeRecipeResolvedIngredientsItemsDependenciesItems `json:"dependencies"`

	// ingredient
	// Required: true
	Ingredient *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredient `json:"ingredient"`

	// The ingredient options of the resolved ingredient which had their conditions met by the recipe
	IngredientOptions []*V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientOptionsItems `json:"ingredient_options"`

	// ingredient version
	// Required: true
	IngredientVersion *V1SolutionRecipeRecipeResolvedIngredientsItemsIngredientVersion `json:"ingredient_version"`

	// The patches to apply to this ingredient's source before building, if any
	Patches []*V1SolutionRecipeRecipeResolvedIngredientsItemsPatchesItems `json:"patches"`
	...
	ResolvedRequirements []*V1SolutionRecipeRecipeResolvedIngredientsItemsResolvedRequirementsItems `json:"resolved_requirements"`
}

// Validate validates this v1 solution recipe recipe resolved ingredients items
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateAlternatives(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateArtifactID(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateBuildScripts(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateDependencies(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateIngredient(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateIngredientOptions(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateIngredientVersion(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validatePatches(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) validateResolvedRequirements(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SolutionRecipeRecipeResolvedIngredientsItems) UnmarshalBinary(b []byte) error {
	var res V1SolutionRecipeRecipeResolvedIngredientsItems
