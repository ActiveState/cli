...
// V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems Requirement Sub Schema
//
// An order requirement is a single package name and version specifier requested in an order.
// swagger:model v1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems
type V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems struct {
	...
	// Min Items: 1
	VersionRequirements []*V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItemsVersionRequirementsItems `json:"version_requirements"`
}

// Validate validates this v1 recipe response recipes items resolved ingredients items resolved requirements items
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) validateIngredientVersionID(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) validateRevision(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) validateVersionRequirements(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems) UnmarshalBinary(b []byte) error {
	var res V1RecipeResponseRecipesItemsResolvedIngredientsItemsResolvedRequirementsItems
