...
// ContextValidate validate this revision all of0 based on the context it is used
func (m *RevisionAllOf0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RevisionAllOf0) contextValidateProvidedFeatures(ctx context.Context, formats strfmt.Registry) error {
