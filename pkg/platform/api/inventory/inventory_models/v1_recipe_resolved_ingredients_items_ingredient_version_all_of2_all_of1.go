...
// V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1
type V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1 struct {
...
// Validate validates this v1 recipe resolved ingredients items ingredient version all of2 all of1
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1) UnmarshalBinary(b []byte) error {
	var res V1RecipeResolvedIngredientsItemsIngredientVersionAllOf2AllOf1
