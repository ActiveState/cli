...
//
// swagger:model v1RevisionBase
type V1RevisionBase struct {
...
// Validate validates this v1 revision base
func (m *V1RevisionBase) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RevisionBase) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1RevisionBase) validateComment(formats strfmt.Registry) error {
...
func (m *V1RevisionBase) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RevisionBase) UnmarshalBinary(b []byte) error {
	var res V1RevisionBase
