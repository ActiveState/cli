...
type V1KernelVersionCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1KernelVersionCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1KernelVersionCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
