...
// V1CPUExtensionAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1CpuExtensionAllOf2
type V1CPUExtensionAllOf2 struct {
...
// Validate validates this v1 Cpu extension all of2
func (m *V1CPUExtensionAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1CPUExtensionAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CPUExtensionAllOf2) UnmarshalBinary(b []byte) error {
	var res V1CPUExtensionAllOf2
