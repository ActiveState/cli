...
// V1RecipePlatformLibcVersionAllOf1AllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1RecipePlatformLibcVersionAllOf1AllOf0
type V1RecipePlatformLibcVersionAllOf1AllOf0 struct {
...
// Validate validates this v1 recipe platform libc version all of1 all of0
func (m *V1RecipePlatformLibcVersionAllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipePlatformLibcVersionAllOf1AllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1RecipePlatformLibcVersionAllOf1AllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1RecipePlatformLibcVersionAllOf1AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipePlatformLibcVersionAllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1RecipePlatformLibcVersionAllOf1AllOf0
