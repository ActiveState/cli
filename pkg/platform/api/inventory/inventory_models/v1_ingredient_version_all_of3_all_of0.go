...
// V1IngredientVersionAllOf3AllOf0 v1 ingredient version all of3 all of0
// swagger:model v1IngredientVersionAllOf3AllOf0
type V1IngredientVersionAllOf3AllOf0 struct {
...
// Validate validates this v1 ingredient version all of3 all of0
func (m *V1IngredientVersionAllOf3AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionAllOf3AllOf0) validateDependencySets(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf0) validateLicenseManifestURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf0) validatePlatformSourceURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionAllOf3AllOf0) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionAllOf3AllOf0
