...
// V1RevisionAllOf1 Revision Base
//
...
// swagger:model v1RevisionAllOf1
type V1RevisionAllOf1 struct {
...
// Validate validates this v1 revision all of1
func (m *V1RevisionAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RevisionAllOf1) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1RevisionAllOf1) validateComment(formats strfmt.Registry) error {
...
func (m *V1RevisionAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RevisionAllOf1) UnmarshalBinary(b []byte) error {
	var res V1RevisionAllOf1
