...
// V1RecipeResponseRecipesItems Recipe
//
...
// swagger:model v1RecipeResponseRecipesItems
type V1RecipeResponseRecipesItems struct {
	...
	// image
	// Required: true
	Image *V1RecipeResponseRecipesItemsImage `json:"image"`
	...
	// platform
	// Required: true
	Platform *V1RecipeResponseRecipesItemsPlatform `json:"platform"`
	...
	// Min Items: 1
	// Unique: true
	ResolvedIngredients []*V1RecipeResponseRecipesItemsResolvedIngredientsItems `json:"resolved_ingredients"`
...
// Validate validates this v1 recipe response recipes items
func (m *V1RecipeResponseRecipesItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResponseRecipesItems) validateFromRecipeStore(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validateImage(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validatePlatform(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validateRecipeID(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validateRecipeStoreTimestamp(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validateResolvedIngredients(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) validateSolverVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResponseRecipesItems) UnmarshalBinary(b []byte) error {
	var res V1RecipeResponseRecipesItems
