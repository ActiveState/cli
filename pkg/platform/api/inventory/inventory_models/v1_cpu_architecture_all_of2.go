...
// V1CPUArchitectureAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1CpuArchitectureAllOf2
type V1CPUArchitectureAllOf2 struct {
...
// Validate validates this v1 Cpu architecture all of2
func (m *V1CPUArchitectureAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1CPUArchitectureAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1CPUArchitectureAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1CPUArchitectureAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CPUArchitectureAllOf2) UnmarshalBinary(b []byte) error {
	var res V1CPUArchitectureAllOf2
