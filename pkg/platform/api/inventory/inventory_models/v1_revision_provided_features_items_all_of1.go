...
// V1RevisionProvidedFeaturesItemsAllOf1 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1RevisionProvidedFeaturesItemsAllOf1
type V1RevisionProvidedFeaturesItemsAllOf1 struct {
...
// Validate validates this v1 revision provided features items all of1
func (m *V1RevisionProvidedFeaturesItemsAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RevisionProvidedFeaturesItemsAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItemsAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItemsAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RevisionProvidedFeaturesItemsAllOf1) UnmarshalBinary(b []byte) error {
	var res V1RevisionProvidedFeaturesItemsAllOf1
