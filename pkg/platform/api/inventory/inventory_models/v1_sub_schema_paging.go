...
// V1SubSchemaPaging Paging
//
// Paging data
//
// swagger:model v1SubSchemaPaging
type V1SubSchemaPaging struct {
...
// Validate validates this v1 sub schema paging
func (m *V1SubSchemaPaging) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SubSchemaPaging) validateAvailableCount(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPaging) validateItemCount(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPaging) validateLimit(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPaging) validatePage(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPaging) validatePageCount(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPaging) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SubSchemaPaging) UnmarshalBinary(b []byte) error {
	var res V1SubSchemaPaging
