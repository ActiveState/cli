...
func (m *V1RevisionAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RevisionAllOf0) validateProvidedFeatures(formats strfmt.Registry) error {
...
func (m *V1RevisionAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RevisionAllOf0) UnmarshalBinary(b []byte) error {
	var res V1RevisionAllOf0
