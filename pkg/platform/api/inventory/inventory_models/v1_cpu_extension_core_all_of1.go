...
type V1CPUExtensionCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1CPUExtensionCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1CPUExtensionCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
