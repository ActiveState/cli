...
type V1IngredientVersionAllOf3 struct {
	V1IngredientVersionAllOf3AllOf0

	V1IngredientVersionAllOf3AllOf1
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1IngredientVersionAllOf3) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 V1IngredientVersionAllOf3AllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.V1IngredientVersionAllOf3AllOf0 = aO0

	// AO1
	var aO1 V1IngredientVersionAllOf3AllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.V1IngredientVersionAllOf3AllOf1 = aO1
...
func (m V1IngredientVersionAllOf3) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.V1IngredientVersionAllOf3AllOf0)
	if err != nil {
		return nil, err
	}
	_parts = append(_parts, aO0)

	aO1, err := swag.WriteJSON(m.V1IngredientVersionAllOf3AllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *V1IngredientVersionAllOf3) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with V1IngredientVersionAllOf3AllOf0
	if err := m.V1IngredientVersionAllOf3AllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with V1IngredientVersionAllOf3AllOf1
	if err := m.V1IngredientVersionAllOf3AllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
