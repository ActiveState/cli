...
// V1BuildFlagRevisionCoreAllOf1 Revision Base
//
...
// swagger:model v1BuildFlagRevisionCoreAllOf1
type V1BuildFlagRevisionCoreAllOf1 struct {
...
// Validate validates this v1 build flag revision core all of1
func (m *V1BuildFlagRevisionCoreAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildFlagRevisionCoreAllOf1) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1BuildFlagRevisionCoreAllOf1) validateComment(formats strfmt.Registry) error {
...
func (m *V1BuildFlagRevisionCoreAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildFlagRevisionCoreAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildFlagRevisionCoreAllOf1
