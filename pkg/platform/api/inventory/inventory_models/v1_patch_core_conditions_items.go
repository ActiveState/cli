...
// V1PatchCoreConditionsItems Condition Sub Schema
//
...
// swagger:model v1PatchCoreConditionsItems
type V1PatchCoreConditionsItems struct {
	...
	// Required: true
	// Min Length: 1
	Requirements []*V1PatchCoreConditionsItemsRequirementsItems `json:"requirements"`
}

// Validate validates this v1 patch core conditions items
func (m *V1PatchCoreConditionsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1PatchCoreConditionsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1PatchCoreConditionsItems) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1PatchCoreConditionsItems) validateRequirements(formats strfmt.Registry) error {
...
func (m *V1PatchCoreConditionsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1PatchCoreConditionsItems) UnmarshalBinary(b []byte) error {
	var res V1PatchCoreConditionsItems
