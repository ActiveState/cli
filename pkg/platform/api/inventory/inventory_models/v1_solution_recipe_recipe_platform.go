...
// V1SolutionRecipeRecipePlatform Platform
//
// A platform upon which a build can be built.
// swagger:model v1SolutionRecipeRecipePlatform
type V1SolutionRecipeRecipePlatform struct {

	// cpu architecture
	// Required: true
	CPUArchitecture *V1SolutionRecipeRecipePlatformCPUArchitecture `json:"cpu_architecture"`

	// cpu extensions
	CPUExtensions []*V1SolutionRecipeRecipePlatformCPUExtensionsItems `json:"cpu_extensions"`
	...
	// gpu architecture
	GpuArchitecture *V1SolutionRecipeRecipePlatformGpuArchitecture `json:"gpu_architecture,omitempty"`

	// images
	// Required: true
	Images []*V1SolutionRecipeRecipePlatformImagesItems `json:"images"`
	...
	// kernel
	// Required: true
	Kernel *V1SolutionRecipeRecipePlatformKernel `json:"kernel"`

	// kernel version
	// Required: true
	KernelVersion *V1SolutionRecipeRecipePlatformKernelVersion `json:"kernel_version"`

	// libc
	Libc *V1SolutionRecipeRecipePlatformLibc `json:"libc,omitempty"`

	// libc version
	LibcVersion *V1SolutionRecipeRecipePlatformLibcVersion `json:"libc_version,omitempty"`

	// links
	// Required: true
	Links *V1SolutionRecipeRecipePlatformLinks `json:"links"`

	// operating system
	// Required: true
	OperatingSystem *V1SolutionRecipeRecipePlatformOperatingSystem `json:"operating_system"`

	// operating system version
	// Required: true
	OperatingSystemVersion *V1SolutionRecipeRecipePlatformOperatingSystemVersion `json:"operating_system_version"`
...
// Validate validates this v1 solution recipe recipe platform
func (m *V1SolutionRecipeRecipePlatform) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SolutionRecipeRecipePlatform) validateCPUArchitecture(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateCPUExtensions(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateDisplayName(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateEndOfSupportDate(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateGpuArchitecture(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateImages(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateKernel(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateKernelVersion(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateLibc(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateLibcVersion(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateLinks(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateOperatingSystem(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validateOperatingSystemVersion(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) validatePlatformID(formats strfmt.Registry) error {
...
func (m *V1SolutionRecipeRecipePlatform) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SolutionRecipeRecipePlatform) UnmarshalBinary(b []byte) error {
	var res V1SolutionRecipeRecipePlatform
