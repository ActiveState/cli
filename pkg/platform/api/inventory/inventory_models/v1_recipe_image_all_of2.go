...
// V1RecipeImageAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1RecipeImageAllOf2
type V1RecipeImageAllOf2 struct {
...
// Validate validates this v1 recipe image all of2
func (m *V1RecipeImageAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeImageAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1RecipeImageAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1RecipeImageAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeImageAllOf2) UnmarshalBinary(b []byte) error {
	var res V1RecipeImageAllOf2
