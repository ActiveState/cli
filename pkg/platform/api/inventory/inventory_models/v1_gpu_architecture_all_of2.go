...
// V1GpuArchitectureAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1GpuArchitectureAllOf2
type V1GpuArchitectureAllOf2 struct {
...
// Validate validates this v1 gpu architecture all of2
func (m *V1GpuArchitectureAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1GpuArchitectureAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1GpuArchitectureAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1GpuArchitectureAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1GpuArchitectureAllOf2) UnmarshalBinary(b []byte) error {
	var res V1GpuArchitectureAllOf2
