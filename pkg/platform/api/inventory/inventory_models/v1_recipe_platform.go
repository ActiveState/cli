...
// V1RecipePlatform Platform
//
// A platform upon which a build can be built.
// swagger:model v1RecipePlatform
type V1RecipePlatform struct {

	// cpu architecture
	// Required: true
	CPUArchitecture *V1RecipePlatformCPUArchitecture `json:"cpu_architecture"`

	// cpu extensions
	CPUExtensions []*V1RecipePlatformCPUExtensionsItems `json:"cpu_extensions"`
	...
	// gpu architecture
	GpuArchitecture *V1RecipePlatformGpuArchitecture `json:"gpu_architecture,omitempty"`

	// images
	// Required: true
	Images []*V1RecipePlatformImagesItems `json:"images"`
	...
	// kernel
	// Required: true
	Kernel *V1RecipePlatformKernel `json:"kernel"`

	// kernel version
	// Required: true
	KernelVersion *V1RecipePlatformKernelVersion `json:"kernel_version"`

	// libc
	Libc *V1RecipePlatformLibc `json:"libc,omitempty"`

	// libc version
	LibcVersion *V1RecipePlatformLibcVersion `json:"libc_version,omitempty"`

	// links
	// Required: true
	Links *V1RecipePlatformLinks `json:"links"`

	// operating system
	// Required: true
	OperatingSystem *V1RecipePlatformOperatingSystem `json:"operating_system"`

	// operating system version
	// Required: true
	OperatingSystemVersion *V1RecipePlatformOperatingSystemVersion `json:"operating_system_version"`
...
// Validate validates this v1 recipe platform
func (m *V1RecipePlatform) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipePlatform) validateCPUArchitecture(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateCPUExtensions(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateDisplayName(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateEndOfSupportDate(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateGpuArchitecture(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateImages(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateKernel(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateKernelVersion(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateLibc(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateLibcVersion(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateLinks(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateOperatingSystem(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validateOperatingSystemVersion(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) validatePlatformID(formats strfmt.Registry) error {
...
func (m *V1RecipePlatform) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipePlatform) UnmarshalBinary(b []byte) error {
	var res V1RecipePlatform
