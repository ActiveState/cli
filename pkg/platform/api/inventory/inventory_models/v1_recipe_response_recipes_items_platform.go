...
// V1RecipeResponseRecipesItemsPlatform Platform
//
// A platform upon which a build can be built.
// swagger:model v1RecipeResponseRecipesItemsPlatform
type V1RecipeResponseRecipesItemsPlatform struct {

	// cpu architecture
	// Required: true
	CPUArchitecture *V1RecipeResponseRecipesItemsPlatformCPUArchitecture `json:"cpu_architecture"`

	// cpu extensions
	CPUExtensions []*V1RecipeResponseRecipesItemsPlatformCPUExtensionsItems `json:"cpu_extensions"`
	...
	// gpu architecture
	GpuArchitecture *V1RecipeResponseRecipesItemsPlatformGpuArchitecture `json:"gpu_architecture,omitempty"`

	// images
	// Required: true
	Images []*V1RecipeResponseRecipesItemsPlatformImagesItems `json:"images"`
	...
	// kernel
	// Required: true
	Kernel *V1RecipeResponseRecipesItemsPlatformKernel `json:"kernel"`

	// kernel version
	// Required: true
	KernelVersion *V1RecipeResponseRecipesItemsPlatformKernelVersion `json:"kernel_version"`

	// libc
	Libc *V1RecipeResponseRecipesItemsPlatformLibc `json:"libc,omitempty"`

	// libc version
	LibcVersion *V1RecipeResponseRecipesItemsPlatformLibcVersion `json:"libc_version,omitempty"`

	// links
	// Required: true
	Links *V1RecipeResponseRecipesItemsPlatformLinks `json:"links"`

	// operating system
	// Required: true
	OperatingSystem *V1RecipeResponseRecipesItemsPlatformOperatingSystem `json:"operating_system"`

	// operating system version
	// Required: true
	OperatingSystemVersion *V1RecipeResponseRecipesItemsPlatformOperatingSystemVersion `json:"operating_system_version"`
...
// Validate validates this v1 recipe response recipes items platform
func (m *V1RecipeResponseRecipesItemsPlatform) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateCPUArchitecture(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateCPUExtensions(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateDisplayName(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateEndOfSupportDate(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateGpuArchitecture(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateImages(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateKernel(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateKernelVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateLibc(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateLibcVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateLinks(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateOperatingSystem(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validateOperatingSystemVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) validatePlatformID(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsPlatform) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResponseRecipesItemsPlatform) UnmarshalBinary(b []byte) error {
	var res V1RecipeResponseRecipesItemsPlatform
