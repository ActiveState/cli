...
// V1IngredientVersionAllOf1 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1IngredientVersionAllOf1
type V1IngredientVersionAllOf1 struct {
...
// Validate validates this v1 ingredient version all of1
func (m *V1IngredientVersionAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionAllOf1) validateRevision(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf1) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionAllOf1) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionAllOf1
