...
// V1LibcVersionAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1LibcVersionAllOf2
type V1LibcVersionAllOf2 struct {
...
// Validate validates this v1 libc version all of2
func (m *V1LibcVersionAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1LibcVersionAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1LibcVersionAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1LibcVersionAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1LibcVersionAllOf2) UnmarshalBinary(b []byte) error {
	var res V1LibcVersionAllOf2
