...
type V1LibcVersionCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1LibcVersionCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1LibcVersionCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
