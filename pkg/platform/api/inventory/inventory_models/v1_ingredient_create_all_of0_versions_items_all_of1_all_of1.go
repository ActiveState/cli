...
// V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1
type V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1 struct {
...
// Validate validates this v1 ingredient create all of0 versions items all of1 all of1
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1) UnmarshalBinary(b []byte) error {
	var res V1IngredientCreateAllOf0VersionsItemsAllOf1AllOf1
