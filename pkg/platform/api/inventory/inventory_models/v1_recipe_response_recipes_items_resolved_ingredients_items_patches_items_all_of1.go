...
// V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1 Patch Core
//
...
type V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1 struct {
	...
	Conditions []*V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1ConditionsItems `json:"conditions"`
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1) validateConditions(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1) validateContent(formats strfmt.Registry) error {
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf1) validateDescription(formats strfmt.Registry) error {
