...
type V1ImageRevisionCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1ImageRevisionCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1ImageRevisionCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
