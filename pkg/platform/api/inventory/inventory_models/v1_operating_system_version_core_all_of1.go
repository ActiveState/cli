...
type V1OperatingSystemVersionCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1OperatingSystemVersionCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1OperatingSystemVersionCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
