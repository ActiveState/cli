...
// V1IngredientVersionAllOf3AllOf1AllOf1 Revision Base
//
...
// swagger:model v1IngredientVersionAllOf3AllOf1AllOf1
type V1IngredientVersionAllOf3AllOf1AllOf1 struct {
...
// Validate validates this v1 ingredient version all of3 all of1 all of1
func (m *V1IngredientVersionAllOf3AllOf1AllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionAllOf3AllOf1AllOf1) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf1AllOf1) validateComment(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf1AllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionAllOf3AllOf1AllOf1) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionAllOf3AllOf1AllOf1
