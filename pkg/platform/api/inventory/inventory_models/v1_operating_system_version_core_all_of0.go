...
// V1OperatingSystemVersionCoreAllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1OperatingSystemVersionCoreAllOf0
type V1OperatingSystemVersionCoreAllOf0 struct {
...
// Validate validates this v1 operating system version core all of0
func (m *V1OperatingSystemVersionCoreAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersionCoreAllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreAllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionCoreAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OperatingSystemVersionCoreAllOf0) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersionCoreAllOf0
