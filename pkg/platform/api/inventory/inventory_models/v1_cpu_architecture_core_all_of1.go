...
type V1CPUArchitectureCoreAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1CPUArchitectureCoreAllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1CPUArchitectureCoreAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
