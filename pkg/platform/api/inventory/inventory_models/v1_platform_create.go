...
// Validate validates this v1 platform create
func (m *V1PlatformCreate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1PlatformCreate) validateCPUArchitectureID(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateCPUExtensions(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateEndOfSupportDate(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateGpuArchitectureID(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateKernelVersionID(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateLibcVersionID(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) validateOperatingSystemVersionID(formats strfmt.Registry) error {
...
func (m *V1PlatformCreate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1PlatformCreate) UnmarshalBinary(b []byte) error {
	var res V1PlatformCreate
