...
// V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1 Revision Base
//
...
// swagger:model v1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1
type V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1 struct {
...
// Validate validates this v1 recipe platform images items all of1 all of1 all of1 all of1
func (m *V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) validateComment(formats strfmt.Registry) error {
...
func (m *V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) UnmarshalBinary(b []byte) error {
	var res V1RecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1
