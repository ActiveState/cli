...
// V1RecipeResolvedIngredientsItemsIngredientOptionsItems Ingredient Option
//
...
// swagger:model v1RecipeResolvedIngredientsItemsIngredientOptionsItems
type V1RecipeResolvedIngredientsItemsIngredientOptionsItems struct {
	...
	ConditionSets []*V1RecipeResolvedIngredientsItemsIngredientOptionsItemsConditionSetsItems `json:"condition_sets"`
}

// Validate validates this v1 recipe resolved ingredients items ingredient options items
func (m *V1RecipeResolvedIngredientsItemsIngredientOptionsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResolvedIngredientsItemsIngredientOptionsItems) validateCommandLineArgs(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientOptionsItems) validateConditionSets(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientOptionsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResolvedIngredientsItemsIngredientOptionsItems) UnmarshalBinary(b []byte) error {
	var res V1RecipeResolvedIngredientsItemsIngredientOptionsItems
