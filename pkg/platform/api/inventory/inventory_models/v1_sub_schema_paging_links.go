...
// V1SubSchemaPagingLinks Paging Links
//
// Links for a model that include links for paging data
//
// swagger:model v1SubSchemaPagingLinks
type V1SubSchemaPagingLinks struct {
...
// Validate validates this v1 sub schema paging links
func (m *V1SubSchemaPagingLinks) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SubSchemaPagingLinks) validateFirst(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPagingLinks) validateLast(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPagingLinks) validateNext(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPagingLinks) validatePrevious(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPagingLinks) validateSelf(formats strfmt.Registry) error {
...
func (m *V1SubSchemaPagingLinks) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SubSchemaPagingLinks) UnmarshalBinary(b []byte) error {
	var res V1SubSchemaPagingLinks
