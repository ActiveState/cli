...
type V1Revision struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1RevisionProvidedFeaturesItems0 `json:"provided_features"`
}
...
// V1RevisionProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1RevisionProvidedFeaturesItems0
type V1RevisionProvidedFeaturesItems0 struct {
...
func (m *V1RevisionProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
func (m V1RevisionProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
...
// Validate validates this v1 revision provided features items0
func (m *V1RevisionProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RevisionProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1RevisionProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1RevisionProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1RevisionProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1RevisionProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
