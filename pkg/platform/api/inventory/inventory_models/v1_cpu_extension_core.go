...
type V1CPUExtensionCore struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1CPUExtensionCoreProvidedFeaturesItems0 `json:"provided_features"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1CPUExtensionCore) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Name *string `json:"name"`
	}
...
func (m V1CPUExtensionCore) MarshalJSON() ([]byte, error) {
...
// Validate validates this v1 Cpu extension core
func (m *V1CPUExtensionCore) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1CPUExtensionCore) validateName(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCore) validateProvidedFeatures(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCore) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CPUExtensionCore) UnmarshalBinary(b []byte) error {
	var res V1CPUExtensionCore
...
// V1CPUExtensionCoreProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1CPUExtensionCoreProvidedFeaturesItems0
type V1CPUExtensionCoreProvidedFeaturesItems0 struct {
...
// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1CPUExtensionCoreProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)
...
// Validate validates this v1 CPU extension core provided features items0
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1CPUExtensionCoreProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1CPUExtensionCoreProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
