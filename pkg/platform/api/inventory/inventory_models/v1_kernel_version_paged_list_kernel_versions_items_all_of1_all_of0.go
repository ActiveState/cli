...
// V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0
type V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0 struct {
...
// Validate validates this v1 kernel version paged list kernel versions items all of1 all of0
func (m *V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionPagedListKernelVersionsItemsAllOf1AllOf0
