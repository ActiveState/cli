...
// V1ImageAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1ImageAllOf2
type V1ImageAllOf2 struct {
...
// Validate validates this v1 image all of2
func (m *V1ImageAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ImageAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1ImageAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1ImageAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ImageAllOf2) UnmarshalBinary(b []byte) error {
	var res V1ImageAllOf2
