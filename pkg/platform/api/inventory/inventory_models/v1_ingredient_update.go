...
// Validate validates this v1 ingredient update
func (m *V1IngredientUpdate) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientUpdate) validateDescription(formats strfmt.Registry) error {
...
func (m *V1IngredientUpdate) validateWebsite(formats strfmt.Registry) error {
...
func (m *V1IngredientUpdate) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientUpdate) UnmarshalBinary(b []byte) error {
	var res V1IngredientUpdate
