...
// V1NormalizedNames Unnormalized Names
//
// A list of mappings from unnormalized to normalized names.
//
// swagger:model v1NormalizedNames
type V1NormalizedNames struct {
...
// Validate validates this v1 normalized names
func (m *V1NormalizedNames) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1NormalizedNames) validateNormalizedNames(formats strfmt.Registry) error {
...
func (m *V1NormalizedNames) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1NormalizedNames) UnmarshalBinary(b []byte) error {
	var res V1NormalizedNames
