...
func (m *V1GpuArchitectureCore) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 V1GpuArchitectureCoreAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.V1GpuArchitectureCoreAllOf1 = aO1
...
func (m V1GpuArchitectureCore) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.V1GpuArchitectureCoreAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *V1GpuArchitectureCore) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with V1GpuArchitectureCoreAllOf1
	if err := m.V1GpuArchitectureCoreAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
