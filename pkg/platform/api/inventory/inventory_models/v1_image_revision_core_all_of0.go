...
// V1ImageRevisionCoreAllOf0 Version Info
//
// Properties shared by all versioned resources
// swagger:model v1ImageRevisionCoreAllOf0
type V1ImageRevisionCoreAllOf0 struct {
...
// Validate validates this v1 image revision core all of0
func (m *V1ImageRevisionCoreAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ImageRevisionCoreAllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1ImageRevisionCoreAllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1ImageRevisionCoreAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1ImageRevisionCoreAllOf0) UnmarshalBinary(b []byte) error {
	var res V1ImageRevisionCoreAllOf0
