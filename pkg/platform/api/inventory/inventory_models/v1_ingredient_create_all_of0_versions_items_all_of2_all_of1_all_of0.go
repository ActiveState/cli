...
// V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0 v1 ingredient create all of0 versions items all of2 all of1 all of0
...
type V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0 struct {
	...
	// ingredient options
	IngredientOptions []*V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0IngredientOptionsItems `json:"ingredient_options"`
...
// Validate validates this v1 ingredient create all of0 versions items all of2 all of1 all of0
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) validateDependencySets(formats strfmt.Registry) error {
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) validateIngredientOptions(formats strfmt.Registry) error {
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) validatePlatformSourceURI(formats strfmt.Registry) error {
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1IngredientCreateAllOf0VersionsItemsAllOf2AllOf1AllOf0
