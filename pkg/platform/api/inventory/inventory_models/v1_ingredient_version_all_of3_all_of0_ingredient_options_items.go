...
// V1IngredientVersionAllOf3AllOf0IngredientOptionsItems Ingredient Option
//
...
// swagger:model v1IngredientVersionAllOf3AllOf0IngredientOptionsItems
type V1IngredientVersionAllOf3AllOf0IngredientOptionsItems struct {
	...
	ConditionSets []*V1IngredientVersionAllOf3AllOf0IngredientOptionsItemsConditionSetsItems `json:"condition_sets"`
}

// Validate validates this v1 ingredient version all of3 all of0 ingredient options items
func (m *V1IngredientVersionAllOf3AllOf0IngredientOptionsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionAllOf3AllOf0IngredientOptionsItems) validateCommandLineArgs(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf0IngredientOptionsItems) validateConditionSets(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf3AllOf0IngredientOptionsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionAllOf3AllOf0IngredientOptionsItems) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionAllOf3AllOf0IngredientOptionsItems
