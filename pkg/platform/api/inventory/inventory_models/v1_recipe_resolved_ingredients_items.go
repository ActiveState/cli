...
// V1RecipeResolvedIngredientsItems Resolved Ingredient
//
// An ingredient that is part of a recipe's resolved requirements
// swagger:model v1RecipeResolvedIngredientsItems
type V1RecipeResolvedIngredientsItems struct {
	...
	BuildScripts []*V1RecipeResolvedIngredientsItemsBuildScriptsItems `json:"build_scripts"`
	...
	Dependencies []*V1RecipeResolvedIngredientsItemsDependenciesItems `json:"dependencies"`

	// ingredient
	// Required: true
	Ingredient *V1RecipeResolvedIngredientsItemsIngredient `json:"ingredient"`

	// The ingredient options of the resolved ingredient which had their conditions met by the recipe
	IngredientOptions []*V1RecipeResolvedIngredientsItemsIngredientOptionsItems `json:"ingredient_options"`

	// ingredient version
	// Required: true
	IngredientVersion *V1RecipeResolvedIngredientsItemsIngredientVersion `json:"ingredient_version"`

	// The patches to apply to this ingredient's source before building, if any
	Patches []*V1RecipeResolvedIngredientsItemsPatchesItems `json:"patches"`
	...
	ResolvedRequirements []*V1RecipeResolvedIngredientsItemsResolvedRequirementsItems `json:"resolved_requirements"`
}

// Validate validates this v1 recipe resolved ingredients items
func (m *V1RecipeResolvedIngredientsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResolvedIngredientsItems) validateAlternatives(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateArtifactID(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateBuildScripts(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateDependencies(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateIngredient(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateIngredientOptions(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateIngredientVersion(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validatePatches(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) validateResolvedRequirements(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResolvedIngredientsItems) UnmarshalBinary(b []byte) error {
	var res V1RecipeResolvedIngredientsItems
