...
// V1OrderRequirementsItems Requirement Sub Schema
//
// An order requirement is a single package name and version specifier requested in an order.
// swagger:model v1OrderRequirementsItems
type V1OrderRequirementsItems struct {
...
// Validate validates this v1 order requirements items
func (m *V1OrderRequirementsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OrderRequirementsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1OrderRequirementsItems) validateIngredientVersionID(formats strfmt.Registry) error {
...
func (m *V1OrderRequirementsItems) validateVersionRequirements(formats strfmt.Registry) error {
...
func (m *V1OrderRequirementsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OrderRequirementsItems) UnmarshalBinary(b []byte) error {
	var res V1OrderRequirementsItems
