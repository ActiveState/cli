...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf0) UnmarshalBinary(b []byte) error {
	var res V1RecipeResponseRecipesItemsResolvedIngredientsItemsPatchesItemsAllOf0
