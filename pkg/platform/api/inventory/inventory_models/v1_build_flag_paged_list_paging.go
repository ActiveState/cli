...
// V1BuildFlagPagedListPaging Paging
//
// Paging data
// swagger:model v1BuildFlagPagedListPaging
type V1BuildFlagPagedListPaging struct {
...
// Validate validates this v1 build flag paged list paging
func (m *V1BuildFlagPagedListPaging) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildFlagPagedListPaging) validateAvailableCount(formats strfmt.Registry) error {
...
func (m *V1BuildFlagPagedListPaging) validateItemCount(formats strfmt.Registry) error {
...
func (m *V1BuildFlagPagedListPaging) validateLimit(formats strfmt.Registry) error {
...
func (m *V1BuildFlagPagedListPaging) validatePage(formats strfmt.Registry) error {
...
func (m *V1BuildFlagPagedListPaging) validatePageCount(formats strfmt.Registry) error {
...
func (m *V1BuildFlagPagedListPaging) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildFlagPagedListPaging) UnmarshalBinary(b []byte) error {
	var res V1BuildFlagPagedListPaging
