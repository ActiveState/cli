...
type V1KernelVersionCore struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1KernelVersionCoreProvidedFeaturesItems0 `json:"provided_features"`
}
...
func (m *V1KernelVersionCore) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCore) validateVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCore) validateProvidedFeatures(formats strfmt.Registry) error {
...
// V1KernelVersionCoreProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1KernelVersionCoreProvidedFeaturesItems0
type V1KernelVersionCoreProvidedFeaturesItems0 struct {
...
// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1KernelVersionCoreProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1KernelVersionCoreProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)
...
// Validate validates this v1 kernel version core provided features items0
func (m *V1KernelVersionCoreProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionCoreProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionCoreProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1KernelVersionCoreProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1KernelVersionCoreProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionCoreProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
