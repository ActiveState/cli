...
type V1KernelVersion struct {
	...
	// links
	// Required: true
	Links *V1KernelVersionAO0Links `json:"links"`
...
func (m *V1KernelVersion) validateKernelVersionID(formats strfmt.Registry) error {
...
func (m *V1KernelVersion) validateLinks(formats strfmt.Registry) error {
...
func (m *V1KernelVersion) validateRevision(formats strfmt.Registry) error {
...
func (m *V1KernelVersion) validateRevisionTimestamp(formats strfmt.Registry) error {
...
// V1KernelVersionAO0Links Self Link
//
// A self link
// swagger:model V1KernelVersionAO0Links
type V1KernelVersionAO0Links struct {
...
// Validate validates this v1 kernel version a o0 links
func (m *V1KernelVersionAO0Links) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionAO0Links) validateSelf(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1KernelVersionAO0Links) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1KernelVersionAO0Links) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionAO0Links
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// V1KernelVersionAllOf1 Kernel Version Core
//
// The properties of a kernel version needed to create a new one
// swagger:model V1KernelVersionAllOf1
type V1KernelVersionAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1KernelVersionAllOf1ProvidedFeaturesItems0 `json:"provided_features"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1KernelVersionAllOf1) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		SortableVersion []string `json:"sortable_version"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1KernelVersionAllOf1) MarshalJSON() ([]byte, error) {
...
// Validate validates this v1 kernel version all of1
func (m *V1KernelVersionAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1KernelVersionAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1KernelVersionAllOf1) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionAllOf1
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// V1KernelVersionAllOf1ProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1KernelVersionAllOf1ProvidedFeaturesItems0
type V1KernelVersionAllOf1ProvidedFeaturesItems0 struct {
...
// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1KernelVersionAllOf1ProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)
...
// Validate validates this v1 kernel version all of1 provided features items0
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1KernelVersionAllOf1ProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1KernelVersionAllOf1ProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
