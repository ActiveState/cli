...
// V1IngredientVersionRevisionCreateAllOf0 v1 ingredient version revision create all of0
// swagger:model v1IngredientVersionRevisionCreateAllOf0
type V1IngredientVersionRevisionCreateAllOf0 struct {
...
func (m *V1IngredientVersionRevisionCreateAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionRevisionCreateAllOf0) validateBuildScripts(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf0) validatePatches(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionRevisionCreateAllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionRevisionCreateAllOf0) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionRevisionCreateAllOf0
