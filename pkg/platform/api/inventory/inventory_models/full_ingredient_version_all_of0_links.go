...
func (m *FullIngredientVersionAllOf0Links) UnmarshalJSON(raw []byte) error {
	...
	// AO1
	var aO1 FullIngredientVersionAllOf0LinksAllOf1
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.FullIngredientVersionAllOf0LinksAllOf1 = aO1
...
func (m FullIngredientVersionAllOf0Links) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.FullIngredientVersionAllOf0LinksAllOf1)
	if err != nil {
		return nil, err
	}
...
func (m *FullIngredientVersionAllOf0Links) Validate(formats strfmt.Registry) error {
	var res []error
	...
	// validation for a type composition with FullIngredientVersionAllOf0LinksAllOf1
	if err := m.FullIngredientVersionAllOf0LinksAllOf1.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FullIngredientVersionAllOf0Links) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with FullIngredientVersionAllOf0LinksAllOf1
	if err := m.FullIngredientVersionAllOf0LinksAllOf1.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FullIngredientVersionAllOf0Links) UnmarshalBinary(b []byte) error {
	var res FullIngredientVersionAllOf0Links
