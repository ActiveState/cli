...
// V1BuildFlagAllOf2 Revisioned Resource
//
// Properties shared by all revisioned resources
// swagger:model v1BuildFlagAllOf2
type V1BuildFlagAllOf2 struct {
...
// Validate validates this v1 build flag all of2
func (m *V1BuildFlagAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildFlagAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildFlagAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildFlagAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildFlagAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildFlagAllOf2
