...
// V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0 v1 recipe resolved ingredients items ingredient version all of3 all of0
// swagger:model v1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0
type V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0 struct {
	...
	// dependency sets
	DependencySets []*V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0DependencySetsItems `json:"dependency_sets"`

	// ingredient options
	IngredientOptions []*V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0IngredientOptionsItems `json:"ingredient_options"`
...
// Validate validates this v1 recipe resolved ingredients items ingredient version all of3 all of0
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) validateDependencySets(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) validateIngredientOptions(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) validateLicenseManifestURI(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) validatePlatformSourceURI(formats strfmt.Registry) error {
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0) UnmarshalBinary(b []byte) error {
	var res V1RecipeResolvedIngredientsItemsIngredientVersionAllOf3AllOf0
