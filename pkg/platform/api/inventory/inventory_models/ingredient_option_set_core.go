...
func (m *IngredientOptionSetCore) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with IngredientOptionSetCoreAllOf0
	if err := m.IngredientOptionSetCoreAllOf0.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with IngredientOptionSetRevisionCore
	if err := m.IngredientOptionSetRevisionCore.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
