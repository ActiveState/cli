...
// V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0 Ingredient Version Core
//
// The fields of an ingredient version that can be updated
// swagger:model v1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0
type V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0 struct {
...
// Validate validates this v1 ingredient version paged list ingredient versions items all of2 all of0
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) validateCopyrightText(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) validateDocumentationURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) validateLicenseExpression(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) validateReleaseTimestamp(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) validateSourceURI(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionPagedListIngredientVersionsItemsAllOf2AllOf0
