...
type V1OperatingSystemVersion struct {
	...
	// links
	// Required: true
	Links *V1OperatingSystemVersionAO0Links `json:"links"`
...
func (m *V1OperatingSystemVersion) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Links *V1OperatingSystemVersionAO0Links `json:"links"`
...
func (m V1OperatingSystemVersion) MarshalJSON() ([]byte, error) {
...
// Validate validates this v1 operating system version
func (m *V1OperatingSystemVersion) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersion) validateLinks(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersion) validateOperatingSystemVersionID(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersion) validateRevision(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersion) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersion) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1OperatingSystemVersion) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersion
...
// V1OperatingSystemVersionAO0Links Self Link
//
// A self link
// swagger:model V1OperatingSystemVersionAO0Links
type V1OperatingSystemVersionAO0Links struct {
...
// Validate validates this v1 operating system version a o0 links
func (m *V1OperatingSystemVersionAO0Links) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersionAO0Links) validateSelf(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1OperatingSystemVersionAO0Links) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1OperatingSystemVersionAO0Links) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersionAO0Links
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// V1OperatingSystemVersionAllOf1 Operating System Version Core
//
// The properties of an operating system version needed to create a new one
// swagger:model V1OperatingSystemVersionAllOf1
type V1OperatingSystemVersionAllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0 `json:"provided_features"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1OperatingSystemVersionAllOf1) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		SortableVersion []string `json:"sortable_version"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1OperatingSystemVersionAllOf1) MarshalJSON() ([]byte, error) {
...
// Validate validates this v1 operating system version all of1
func (m *V1OperatingSystemVersionAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersionAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1OperatingSystemVersionAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1OperatingSystemVersionAllOf1) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersionAllOf1
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
...
// V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0 Provided Feature
//
// A feature that is provided by a revisioned resource
// swagger:model V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0
type V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0 struct {
...
// UnmarshalJSON unmarshals this object from a JSON structure
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Feature *string `json:"feature"`
...
// MarshalJSON marshals this object to a JSON structure
func (m V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)
...
// Validate validates this v1 operating system version all of1 provided features items0
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) validateFeature(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) validateIsDefaultProvider(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) validateVersion(formats strfmt.Registry) error {
...
// MarshalBinary interface implementation
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0) UnmarshalBinary(b []byte) error {
	var res V1OperatingSystemVersionAllOf1ProvidedFeaturesItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
