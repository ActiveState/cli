...
func (m *V1OperatingSystemVersion) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 V1OperatingSystemVersionAllOf0
...
func (m V1OperatingSystemVersion) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.V1OperatingSystemVersionAllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *V1OperatingSystemVersion) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with V1OperatingSystemVersionAllOf0
