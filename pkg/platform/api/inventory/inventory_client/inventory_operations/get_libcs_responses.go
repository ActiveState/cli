...
/*GetLibcsOK handles this case with default header values.
...
func (o *GetLibcsOK) GetPayload() *inventory_models.V1LibcPagedList {
	return o.Payload
}
...
/*GetLibcsDefault handles this case with default header values.
