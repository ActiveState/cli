...
type GetIngredientOK struct {
	Payload *inventory_models.V1Ingredient
}
...
func (o *GetIngredientOK) GetPayload() *inventory_models.V1Ingredient {
	return o.Payload
}
...
/*GetIngredientDefault handles this case with default header values.
