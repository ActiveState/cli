...
// V1BuildRequestRecipePlatformKernelAllOf0 v1 build request recipe platform kernel all of0
// swagger:model v1BuildRequestRecipePlatformKernelAllOf0
...
func (m *V1BuildRequestRecipePlatformKernelAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformKernelAllOf0) validateKernelID(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelAllOf0) validateLinks(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelAllOf0) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformKernelAllOf0
