...
// V1SubSchemaOrderRequirement Requirement Sub Schema
//
// An order requirement is a single package name and version specifier requested in an order.
//
// swagger:model v1SubSchemaOrderRequirement
type V1SubSchemaOrderRequirement struct {
	...
	// Min Items: 1
	VersionRequirements []*V1SubSchemaVersionRequirement `json:"version_requirements"`
}

// Validate validates this v1 sub schema order requirement
func (m *V1SubSchemaOrderRequirement) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SubSchemaOrderRequirement) validateFeature(formats strfmt.Registry) error {
...
func (m *V1SubSchemaOrderRequirement) validateIngredientVersionID(formats strfmt.Registry) error {
...
func (m *V1SubSchemaOrderRequirement) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1SubSchemaOrderRequirement) validateRevision(formats strfmt.Registry) error {
...
func (m *V1SubSchemaOrderRequirement) validateVersionRequirements(formats strfmt.Registry) error {
...
func (m *V1SubSchemaOrderRequirement) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SubSchemaOrderRequirement) UnmarshalBinary(b []byte) error {
	var res V1SubSchemaOrderRequirement
