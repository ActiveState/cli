...
//
// A self link
// swagger:model v1BuildRequestRecipePlatformLibcAllOf0Links
...
func (m *V1BuildRequestRecipePlatformLibcAllOf0Links) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformLibcAllOf0Links) validateSelf(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformLibcAllOf0Links) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformLibcAllOf0Links
