...
// V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems Condition Sub Schema
//
...
// swagger:model v1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) validateFeature(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) validateNamespace(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) validateRequirements(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2ConditionsItems
