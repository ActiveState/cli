...
// swagger:model v1BuildRequestRecipePlatformKernelAllOf1
...
func (m *V1BuildRequestRecipePlatformKernelAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformKernelAllOf1) validateName(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformKernelAllOf1
