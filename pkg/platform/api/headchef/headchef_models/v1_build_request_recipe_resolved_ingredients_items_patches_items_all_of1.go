...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsPatchesItemsAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsPatchesItemsAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeResolvedIngredientsItemsPatchesItemsAllOf1
