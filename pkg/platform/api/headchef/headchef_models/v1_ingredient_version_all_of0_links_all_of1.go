...
// Validate validates this v1 ingredient version all of0 links all of1
func (m *V1IngredientVersionAllOf0LinksAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1IngredientVersionAllOf0LinksAllOf1) validateIngredient(formats strfmt.Registry) error {
...
func (m *V1IngredientVersionAllOf0LinksAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1IngredientVersionAllOf0LinksAllOf1) UnmarshalBinary(b []byte) error {
	var res V1IngredientVersionAllOf0LinksAllOf1
