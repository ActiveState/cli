...
// swagger:model v1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeResolvedIngredientsItemsIngredientVersionAllOf1
