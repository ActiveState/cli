...
func (m *V1BuildRequestRecipeImageAllOf1) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 V1BuildRequestRecipeImageAllOf1AllOf0
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.V1BuildRequestRecipeImageAllOf1AllOf0 = aO0
...
func (m V1BuildRequestRecipeImageAllOf1) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.V1BuildRequestRecipeImageAllOf1AllOf0)
	if err != nil {
		return nil, err
	}
...
func (m *V1BuildRequestRecipeImageAllOf1) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with V1BuildRequestRecipeImageAllOf1AllOf0
	if err := m.V1BuildRequestRecipeImageAllOf1AllOf0.Validate(formats); err != nil {
		res = append(res, err)
	}
