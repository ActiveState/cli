...
// swagger:model v1BuildRequestRecipePlatformLibcAllOf1
...
func (m *V1BuildRequestRecipePlatformLibcAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformLibcAllOf1) validateName(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformLibcAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformLibcAllOf1
