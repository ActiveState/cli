...
// swagger:model v1BuildRequestRecipeImageAllOf2
...
func (m *V1BuildRequestRecipeImageAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeImageAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeImageAllOf2
