...
// swagger:model v1BuildRequestRecipePlatformCpuExtensionsItemsAllOf2
...
func (m *V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformCPUExtensionsItemsAllOf2
