...
// swagger:model v1BuildRequestRecipePlatformImagesItemsAllOf2
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformImagesItemsAllOf2
