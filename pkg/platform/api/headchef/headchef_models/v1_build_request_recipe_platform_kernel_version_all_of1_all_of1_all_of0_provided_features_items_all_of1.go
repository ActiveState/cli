...
// swagger:model v1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) validateVersion(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1AllOf0ProvidedFeaturesItemsAllOf1
