...
// V1SubSchemaVersionInfo Version Info
//
// Properties shared by all versioned resources
//
// swagger:model v1SubSchemaVersionInfo
type V1SubSchemaVersionInfo struct {
...
// Validate validates this v1 sub schema version info
func (m *V1SubSchemaVersionInfo) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SubSchemaVersionInfo) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1SubSchemaVersionInfo) validateVersion(formats strfmt.Registry) error {
...
func (m *V1SubSchemaVersionInfo) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SubSchemaVersionInfo) UnmarshalBinary(b []byte) error {
	var res V1SubSchemaVersionInfo
