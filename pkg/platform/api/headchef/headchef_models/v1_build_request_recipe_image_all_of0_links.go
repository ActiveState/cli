...
//
// A self link
// swagger:model v1BuildRequestRecipeImageAllOf0Links
...
func (m *V1BuildRequestRecipeImageAllOf0Links) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeImageAllOf0Links) validateSelf(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf0Links) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeImageAllOf0Links
