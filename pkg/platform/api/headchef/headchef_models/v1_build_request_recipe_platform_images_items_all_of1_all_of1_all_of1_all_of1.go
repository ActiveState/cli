...
// swagger:model v1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) validateAuthorPlatformUserID(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) validateComment(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf1AllOf1
