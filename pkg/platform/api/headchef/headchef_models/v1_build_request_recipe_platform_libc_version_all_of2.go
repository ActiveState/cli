...
// swagger:model v1BuildRequestRecipePlatformLibcVersionAllOf2
...
func (m *V1BuildRequestRecipePlatformLibcVersionAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformLibcVersionAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformLibcVersionAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformLibcVersionAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformLibcVersionAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformLibcVersionAllOf2
