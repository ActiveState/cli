...
// swagger:model v1BuildRequestRecipePlatformCpuArchitectureAllOf2
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformCPUArchitectureAllOf2
