...
// StatusMessageEnvelopeBody8 Package Build Completed
//
// A message indicating that a requested package build has completed.
// swagger:model statusMessageEnvelopeBody8
type StatusMessageEnvelopeBody8 struct {
...
// Validate validates this status message envelope body8
func (m *StatusMessageEnvelopeBody8) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StatusMessageEnvelopeBody8) validateArtifact(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) validateIngredientID(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) validateIngredientVersion(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) validatePercent(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) validateSequence(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) validateTotal(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody8) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StatusMessageEnvelopeBody8) UnmarshalBinary(b []byte) error {
	var res StatusMessageEnvelopeBody8
