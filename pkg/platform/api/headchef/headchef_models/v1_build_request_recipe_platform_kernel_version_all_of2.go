...
// swagger:model v1BuildRequestRecipePlatformKernelVersionAllOf2
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformKernelVersionAllOf2
