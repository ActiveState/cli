...
type V1BuildRequestRecipeImageAllOf1AllOf1AllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1BuildRequestRecipeImageAllOf1AllOf1AllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf1AllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
