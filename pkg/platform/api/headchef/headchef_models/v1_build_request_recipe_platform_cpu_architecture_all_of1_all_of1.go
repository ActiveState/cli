...
type V1BuildRequestRecipePlatformCPUArchitectureAllOf1AllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1BuildRequestRecipePlatformCPUArchitectureAllOf1AllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1BuildRequestRecipePlatformCPUArchitectureAllOf1AllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
