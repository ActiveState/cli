...
// V1BuildRequestRecipeImageAllOf1AllOf0 v1 build request recipe image all of1 all of0
// swagger:model v1BuildRequestRecipeImageAllOf1AllOf0
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf0) validateName(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf0) validatePlatformID(formats strfmt.Registry) error {
...
var v1BuildRequestRecipeImageAllOf1AllOf0TypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		v1BuildRequestRecipeImageAllOf1AllOf0TypeTypePropEnum = append(v1BuildRequestRecipeImageAllOf1AllOf0TypeTypePropEnum, v)
	}
}
...
const (
	...
	// V1BuildRequestRecipeImageAllOf1AllOf0TypeMacVMCommand captures enum value "MacVMCommand"
	V1BuildRequestRecipeImageAllOf1AllOf0TypeMacVMCommand string = "MacVMCommand"
...
// prop value enum
func (m *V1BuildRequestRecipeImageAllOf1AllOf0) validateTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, v1BuildRequestRecipeImageAllOf1AllOf0TypeTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *V1BuildRequestRecipeImageAllOf1AllOf0) validateType(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeImageAllOf1AllOf0
