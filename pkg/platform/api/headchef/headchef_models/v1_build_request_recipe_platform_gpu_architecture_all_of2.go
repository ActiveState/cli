...
// swagger:model v1BuildRequestRecipePlatformGpuArchitectureAllOf2
...
func (m *V1BuildRequestRecipePlatformGpuArchitectureAllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformGpuArchitectureAllOf2) validateRevision(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformGpuArchitectureAllOf2) validateRevisionTimestamp(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformGpuArchitectureAllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformGpuArchitectureAllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformGpuArchitectureAllOf2
