...
// swagger:model v1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2) validateConditions(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformImagesItemsAllOf1AllOf1AllOf2
