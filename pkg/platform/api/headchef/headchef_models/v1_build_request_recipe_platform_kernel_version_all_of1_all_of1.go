...
type V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1 struct {
	...
	// provided features
	// Required: true
	ProvidedFeatures []*V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1ProvidedFeaturesItems `json:"provided_features"`
}
...
func (m *V1BuildRequestRecipePlatformKernelVersionAllOf1AllOf1) validateProvidedFeatures(formats strfmt.Registry) error {
