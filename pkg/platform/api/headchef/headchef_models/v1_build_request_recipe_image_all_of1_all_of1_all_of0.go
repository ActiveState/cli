...
// swagger:model v1BuildRequestRecipeImageAllOf1AllOf1AllOf0
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf1AllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf1AllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeImageAllOf1AllOf1AllOf0
