...
// swagger:model v1BuildRequestRecipePlatformOperatingSystemAllOf1
...
func (m *V1BuildRequestRecipePlatformOperatingSystemAllOf1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformOperatingSystemAllOf1) validateHasLibc(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformOperatingSystemAllOf1) validateName(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformOperatingSystemAllOf1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformOperatingSystemAllOf1) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformOperatingSystemAllOf1
