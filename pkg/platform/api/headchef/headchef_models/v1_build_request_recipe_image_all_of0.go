...
// V1BuildRequestRecipeImageAllOf0 v1 build request recipe image all of0
// swagger:model v1BuildRequestRecipeImageAllOf0
...
func (m *V1BuildRequestRecipeImageAllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipeImageAllOf0) validateImageID(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf0) validateLinks(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipeImageAllOf0) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipeImageAllOf0
