...
// swagger:model v1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0
...
func (m *V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0) validateSortableVersion(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0) validateVersion(formats strfmt.Registry) error {
...
func (m *V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0) UnmarshalBinary(b []byte) error {
	var res V1BuildRequestRecipePlatformOperatingSystemVersionAllOf1AllOf0
