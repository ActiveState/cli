...
// StatusMessageEnvelopeBody11 Package Build Started
//
// A message indicating that a requested package build has been started.
// swagger:model statusMessageEnvelopeBody11
type StatusMessageEnvelopeBody11 struct {
...
// Validate validates this status message envelope body11
func (m *StatusMessageEnvelopeBody11) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StatusMessageEnvelopeBody11) validateIngredientID(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody11) validateIngredientVersion(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody11) validatePercent(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody11) validateSequence(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody11) validateTotal(formats strfmt.Registry) error {
...
func (m *StatusMessageEnvelopeBody11) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StatusMessageEnvelopeBody11) UnmarshalBinary(b []byte) error {
	var res StatusMessageEnvelopeBody11
