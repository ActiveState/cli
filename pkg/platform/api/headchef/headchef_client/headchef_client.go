...
// NewHTTPClient creates a new headchef HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Headchef {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new headchef HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Headchef {
...
// New creates a new headchef client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Headchef {
	// ensure nullable parameters have default
	if formats == nil {
