...
import "github.com/ActiveState/cli/pkg/platform/api/buildplanner/response"

func MergeCommit(owner, project, targetRef, otherRef string, strategy response.MergeStrategy) *mergeCommit {
