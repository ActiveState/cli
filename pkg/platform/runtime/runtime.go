...
func (r *Runtime) Update(auth *authentication.Auth, msgHandler *events.RuntimeEventHandler, projDir, sockPath string) error {
	...
	go func() {
		...
		if err := setup.New(r.target, prod, auth, r.analytics).Update(projDir, sockPath); err != nil {
