	...
	tests := []struct {
	...
	}{
		{
			...
			artifact.ArtifactBuildPlanMap{
				strfmt.UUID("bdd5642b-928c-5770-9e12-5816c9676960"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("decfc04f-5770-5663-8d00-e029402e6917"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("e6997088-7854-5498-8c57-afbe4343036a"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("060cc2b8-01e4-5afe-8618-c44ccb25a592"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("06e6c26f-7645-5971-a6ad-277497bdec0c"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("1931b61b-5e8b-5bce-a5ff-5663a0b9b9c3"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("2a2dc52f-8324-59bf-ae5e-082ea2468a28"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("2c8a61b6-995c-5e59-8d52-fac8604c3e88"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("7b923ae1-94a9-574c-bb9e-a89163f0ccb8"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("7b9a5527-a6d0-50b9-a6fe-0c5c73d242cd"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("f6f7099a-2a86-5a30-8098-a111661cfbc5"): artifact.ArtifactBuildPlan{
				...
				strfmt.UUID("fb916bb5-73f9-55f8-9a01-ad79a876e00c"): artifact.ArtifactBuildPlan{
		...
		},
		{
			...
			artifact.ArtifactBuildPlanMap{
				strfmt.UUID("c894fa23-0416-556d-9ca5-fdf9375595bc"): artifact.ArtifactBuildPlan{
...
func TestRequestedArtifactChanges(t *testing.T) {
	...
	t.Run("starting empty", func(t *testing.T) {
		var oldArts artifact.ArtifactBuildPlanMap
