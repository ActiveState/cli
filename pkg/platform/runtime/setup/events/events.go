...
type ChangeSummaryEvent struct {
	artifacts map[artifact.ArtifactID]artifact.ArtifactBuildPlan
...
func (cse ChangeSummaryEvent) Artifacts() map[artifact.ArtifactID]artifact.ArtifactBuildPlan {
...
func newChangeSummaryEvent(artifacts map[artifact.ArtifactID]artifact.ArtifactBuildPlan, requested artifact.ArtifactChangeset, changed artifact.ArtifactChangeset) ChangeSummaryEvent {
