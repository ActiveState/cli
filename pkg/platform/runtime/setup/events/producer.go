...
func (r *RuntimeEventProducer) ChangeSummary(artifacts map[artifact.ArtifactID]artifact.ArtifactBuildPlan, requested artifact.ArtifactChangeset, changed artifact.ArtifactChangeset) {
