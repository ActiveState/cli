...
func TestRequestedArtifactChanges(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			oldArts := ArtifactsFromRecipe(old)
			new := testhelper.LoadRecipe(t, tt.newRecipeName)
			newArts := ArtifactsFromRecipe(new)
			res := RequestedArtifactChanges(oldArts, newArts)
...
func TestResolvedArtifactChanges(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			new := testhelper.LoadRecipe(t, tt.newRecipeName)
			newArts := ArtifactsFromRecipe(new)
			res := ResolvedArtifactChanges(oldArts, newArts)
...
func TestArtifactDownloads(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) {
			...
			downloads := ArtifactDownloads(build)
