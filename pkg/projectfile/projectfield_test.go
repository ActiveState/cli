...
func TestProjectField(t *testing.T) {
	tests := []struct {
		...
		{
			"Add Commit",
			`project: https://platform.activestate.com/owner/project`,
		...
		},
		{
			...
			`project: https://platform.activestate.com/owner/project?branch=main`,
			func(p *projectField) { p.SetCommit("906D66B1-8D89-483C-8E44-6A613B49BADD", true) },
			"https://platform.activestate.com/commit/906D66B1-8D89-483C-8E44-6A613B49BADD",
		},
		{
			"Add Headless Commit, already has Commit and Branch",
			`project: https://platform.activestate.com/owner/project?commitID=25B3DEDF-98E5-400B-8B78-CE12F990B246&branch=main`,
			func(p *projectField) { p.SetCommit("906D66B1-8D89-483C-8E44-6A613B49BADD", true) },
			"https://platform.activestate.com/commit/906D66B1-8D89-483C-8E44-6A613B49BADD",
		},
		{
		...
		},
		{
			...
			`project: https://platform.activestate.com/owner/project?commitID=25B3DEDF-98E5-400B-8B78-CE12F990B246`,
			func(p *projectField) { p.SetBranch("main") },
			"https://platform.activestate.com/owner/project?branch=main&commitID=25B3DEDF-98E5-400B-8B78-CE12F990B246",
		},
		{
			"Set Namespace",
			`project: https://platform.activestate.com/owner1/project1?commitID=25B3DEDF-98E5-400B-8B78-CE12F990B246`,
		...
		},
		{
			...
			`project: https://platform.activestate.com/commit/25B3DEDF-98E5-400B-8B78-CE12F990B246`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			pf := NewProjectField()
			if err := pf.LoadData([]byte(tt.data)); err != nil {
