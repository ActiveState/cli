...
func TestActivate_run(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args{&ActivateParams{&project.Namespace{"foo", "bar"}, tempDir, output.Unset}, activatorMock},
			false,
			true,
		},
		{
		...
		},
		{
			...
			args{&ActivateParams{&project.Namespace{"foo", "bar"}, "", output.Unset}, activatorMock},
			true,
			true,
		},
	}
