...
type AddEmailParams struct {
	...
	*/
	Email *models.AddEmailParamsBody
	/*Username
...
func (o *AddEmailParams) WithEmail(email *models.AddEmailParamsBody) *AddEmailParams {
	o.SetEmail(email)
	return o
}

// SetEmail adds the email to the add email params
func (o *AddEmailParams) SetEmail(email *models.AddEmailParamsBody) {
	o.Email = email
}
