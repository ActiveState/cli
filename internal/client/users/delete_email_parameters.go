...
type DeleteEmailParams struct {
	...
	*/
	Email *models.DeleteEmailParamsBody
	/*Username
...
func (o *DeleteEmailParams) WithEmail(email *models.DeleteEmailParamsBody) *DeleteEmailParams {
	o.SetEmail(email)
	return o
}

// SetEmail adds the email to the delete email params
func (o *DeleteEmailParams) SetEmail(email *models.DeleteEmailParamsBody) {
	o.Email = email
}
