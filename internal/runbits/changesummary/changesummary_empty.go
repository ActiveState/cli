...
func (c *EmptyChangeSummary) ChangeSummary(artifacts artifact.ArtifactInfoMap, requested artifact.ArtifactChangeset, changed artifact.ArtifactChangeset) error {
	return nil
}
