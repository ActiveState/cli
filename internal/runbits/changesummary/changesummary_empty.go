...
func (c *EmptyChangeSummary) ChangeSummary(artifacts artifact.ArtifactBuildPlanMap, requested artifact.ArtifactChangeset, changed artifact.ArtifactChangeset) error {
	return nil
}
