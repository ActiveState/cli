...
// InstallPathOverrideEnvVarName is used to override the default installation path of the state tool. This is intended
// for use in our integration tests, not by end-users.
